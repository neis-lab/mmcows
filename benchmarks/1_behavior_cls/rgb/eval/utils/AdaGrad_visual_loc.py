...
try:
    from utils.line_geometry import plot_line_3d, cal_line_equation, cal_point_on_line_given_z, cal_dist_point_to_line
    from utils.point_geometry import find_outliers
except:
    from line_geometry import plot_line_3d, cal_line_equation, cal_point_on_line_given_z, cal_dist_point_to_line
    from point_geometry import find_outliers

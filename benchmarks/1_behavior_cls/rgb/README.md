...
Data Preparation
------
1. If not done already, clone the repository [mmcows](https://github.com/hienvuvg/mmcows.git)
    ```bash
    git clone https://github.com/hienvuvg/mmcows.git
    ```
...
4. Download sensor_data.zip, visual_data.zip, cropped_bboxes.zip, and trained_model_weights.zip from [this page](https://github.com/hienvuvg/mmcows)

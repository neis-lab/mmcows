...
if __name__ == '__main__':
    ...
    for fold_name, fold_config in folds.items():
        print(f"\n{fold_name}:")
        pre_loader = 'uwb_hd_aa_pre_loader'
        train_data, val_data, test_data = data_loader_s2(pre_loader, sensor_data_dir, group_1.copy(), group_2.copy(), fold_config, val = False)

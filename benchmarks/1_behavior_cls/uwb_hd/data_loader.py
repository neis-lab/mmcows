...
def uwb_hd_pre_loader(sensor_data_dir, id_list, date = '0725'):
    ...
    for cow_id in id_list:
        ...
        head_df = head_df[head_df['timestamp'].isin(uwb_timestamps)] # 1/15 Hz
        ...
        data_df = data_df.drop(columns=['datetime','accel_norm','relative_angle'])
